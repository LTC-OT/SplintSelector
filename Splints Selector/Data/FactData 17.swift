...
let factsData: [Fact] =  [
    ...
    Fact(
      ...
      content: "Splints may also be useful when a major nerve injury deprives the body segment of its normal muscle balance and prevent overstitching of denervated muscles and joint contractures."
    ),
    Fact(
      image: "limit gliding",
    ...
    Fact(
      image: "Shoulder Sling",
      content: "Splinting can be used to treat a wide range of injuries and conditions. It’s used as a part of a comprehensive treatment plan involving other types of physio and occupational therapy."
    ),
    Fact(
      image: "Palmar Hand Orthosis",
